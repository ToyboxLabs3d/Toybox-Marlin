...
#include "env_validate.h"
  ...
  #define BOARD_INFO_NAME "ESP32-HC V4.1"
#endif
...
#define X_STEP_PIN                          PA10
#define X_DIR_PIN                           PB5

#define Y_ENABLE_PIN                        PC9
#define Y_STEP_PIN                          PC0
...
#define E0_DIR_PIN                          PB2
  ...
  //
  #define X_SERIAL_TX_PIN                   PC3
  #define Y_SERIAL_TX_PIN                   PA8
  #define Z_SERIAL_TX_PIN                   PB13
  #define E0_SERIAL_TX_PIN                  PB0
...
// Display
#define BOARD_USART1_TX_PIN                 PC12//PA9   // LCD
#define BOARD_USART1_RX_PIN                 PC11//PA10
