...
#ifndef FAN0_PIN
  #define FAN0_PIN                             7  //默认不使用PWM_FAN冷却喷嘴，如果需要，则取消注释 (PWM_FAN nozzle cooling not used by default; uncomment if needed)
#endif
...
//#define LED_PIN                              8
  ...
  #define CASE_LIGHT_PIN                       8  // 8 默认挤出机风扇作为Case LED，如果需要PWM FAN,则需要将FAN_PIN置为7，LED_PIN置为8 (Extruder fan used as Case LED by default; for PWM FAN, set FAN_PIN to 7 and LED_PIN to 8)
#endif
