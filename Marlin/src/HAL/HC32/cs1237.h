...
#define CS1237_NUM_PREV_VALUES 5
...
private:
    int32_t _data_dir(int32_t input_data);
    int32_t _data_deal(int32_t input_data);
    ...
    // int32_t _cs_data;
    // int32_t _last_data;
    int32_t _cs_threshold;
    // int32_t _cs_deal_val;
    // int32_t _cs_current_val;
    int8_t _cs_trigger_state;

    stc_port_init_t _stcPortInit;

    int32_t _prev_values[CS1237_NUM_PREV_VALUES] = {0};
